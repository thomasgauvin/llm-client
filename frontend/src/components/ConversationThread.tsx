          ...
          <div className="flex-grow overflow-auto mb-4 px-4 pt-4">
            <div className="mx-auto space-y-2">
              ...
              {isLoading && !streamStarted && (
                <div className="text-center text-sm text-zinc-600 dark:text-white font-mono">
                  Thinking...
                </div>
              )}
            </div>
          ...
          >
            ...
            >
              <textarea
                ...
                className="w-full p-2 resize-none focus:outline-none bg-zinc-100 dark:bg-zinc-700 text-zinc-900 dark:text-white  "
